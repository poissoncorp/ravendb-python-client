---
name: csharp-sync
description: Migrates RavenDB C# client features to the Python client. Use when porting C# diffs, patches, or test files to Python, batching sync work, writing migration tests, or generating changelogs for a new Python client release.
---
...
4. **Changelog** — summarize the release following [CHANGELOG.md](CHANGELOG.md)
...
Follow the format in [CHANGELOG.md](CHANGELOG.md).
